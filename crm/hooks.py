...
permission_query_conditions = {
    "CRM Partner": "crm.permissions.partner_permissions.get_partner_permission_query_conditions",
    "CRM Lead": "crm.permissions.partner_permissions.get_crm_lead_permission_query_conditions",
    "CRM Deal": "crm.permissions.partner_permissions.get_crm_deal_permission_query_conditions",
}

has_permission = {
    "CRM Partner": "crm.permissions.partner_permissions.has_partner_permission",
}
...
after_migrate = [
    ...
    "crm.permissions.partner_permissions.setup_partner_permissions"
]
