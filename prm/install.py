...
from prm.fprm.doctype.crm_products.crm_products import create_product_details_script
...
def add_standard_dropdown_items():
	crm_settings = frappe.get_single("FPRM Settings")
...
def add_default_scripts():
	from prm.fprm.doctype.fprm_settings.fprm_settings import create_forecasting_script
