...
from prm.fprm.doctype.crm_dashboard.crm_dashboard import create_default_manager_dashboard
from prm.utils import sales_user_only
...
def get_dashboard(from_date="", to_date="", user=""):
	...
	for l in layout:
		...
		if hasattr(frappe.get_attr("prm.api.dashboard"), method_name):
			method = getattr(frappe.get_attr("prm.api.dashboard"), method_name)
...
def get_base_currency_symbol():
	...
	"""
	base_currency = frappe.db.get_single_value("FPRM Settings", "currency") or "USD"
